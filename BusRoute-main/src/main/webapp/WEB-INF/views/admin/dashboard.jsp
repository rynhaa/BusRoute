...
<body>
	...
	<div class="d-flex">
		<main class="flex-grow-1 p-4">
			...
			<div class="card shadow-lg mb-4 p-5 text-white"
				style="background: linear-gradient(90deg, #4e54c8, #8f94fb); border-radius: 16px; box-shadow: 0 8px 20px rgba(78, 84, 200, 0.6);">
				<h3 class="fw-bold mb-3"
					style="font-size: 1.3rem; line-height: 1.2;"><%=adminName%>님,
					환영합니다!
				</h3>
				<p class="mb-2"
					style="font-size: 1rem; opacity: 0.9; line-height: 1.2;">오늘도 좋은
					하루 되세요.</p>
				<p class="mb-0"
					style="font-size: 0.9rem; opacity: 0.8; line-height: 1.2;">
					현재 시각 <span id="live-clock">--:--</span>
				</p>
			</div>
			...
			<div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
				...
				<div class="card shadow-sm p-4"
					...
					<canvas id="routeChart" width="700" height="300"
						style="width: 700px; height: 300px;"></canvas>
				...
				<!-- 정류장별 이용 통계 -->
				<div class="card shadow-sm p-4" style="width: 800px;">
					...
					<div class="d-flex justify-content-center gap-3 mb-3">
						<select id="stationRegion" name="stationRegion"
							...
							style="max-width: 200px; margin: 0 auto;">
							<option value="승차" selected>최다승차정류장</option>
							<option value="하차">최다하차정류장</option>
							<option value="환승">최다환승정류장</option>
						</select>
					</div>
					<canvas id="stationChart" width="700" height="300"></canvas>
				</div>
			</div>
			<!-- 예측 정확도 통계 -->
			<div class="d-flex justify-content-center mt-4">
				<div class="card shadow-sm p-4 w-100" style="max-width: 1700px;">
					...
					<div class="d-flex justify-content-center gap-3 mb-4">
						<select id="regionSelect" class="form-select"
							...
							<option value="26" selected>울산</option>
  ...
  updateClock(); // 초기 호출
    ...
    const routeListUlsan = [
 	...
 	// 컨트롤러에서 넘긴 기본 선택값 받기
    const selectedRouteId = '<c:out value="${selectedRouteId}" default="" />';
    ...
    function setRouteOptions(routeList,selectedRouteId) {
        ...
        if (selectedRouteId) {
            routeSelect.value = selectedRouteId;  // 기본 선택값 셋팅
        }
    }
    ...
    window.addEventListener('DOMContentLoaded', function() {
        ...
        if (selectedRegion === '24') {
            ...
            setRouteOptions(routeListUlsan, selectedRouteId);
        }else {
            setRouteOptions([], selectedRouteId);
        }
    });
  ...
  울산: {
    ...
    환승: [
      ...
      { station: "학성공원", person: 548 },
    		...
    		window.addEventListener('DOMContentLoaded', () => {
    			  document.getElementById('btnFetchAccuracy').click();
    			});
